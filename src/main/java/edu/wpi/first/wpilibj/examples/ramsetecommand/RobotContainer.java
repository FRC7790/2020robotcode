...
public class RobotContainer {
  ...
  //XboxController m_driverController = new XboxController(OIConstants.kDriverControllerPort); we are not using xbox controller
  //private final DifferentialDrive m_robotBase = new DifferentialDrive(new PWMVictorSPX(0), new PWMVictorSPX(1)); idk if this should go here or not
  Joystick logController = new Joystick(0);
